...
platformio run -e genericESP_prod -t upload  --upload-port 192.168.0.104	
platformio run -e genericESP_prod -t upload  --upload-port 192.168.0.105	
platformio run -e genericESP_prod -t upload  --upload-port 192.168.0.106